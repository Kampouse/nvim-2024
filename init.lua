...
require("flutter-tools").setup {
  flutter_path = "/run/current-system/sw/bin/dart",
  widget_guides = {
    enabled = true
  },
  closing_tags = {
...
vim.keymap.set('n', '<leader>lf', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
...
augroup END
  ...
  augroup MyGroup
    autocmd!
    autocmd BufWritePost * AsyncRun :Format
  augroup END
]])
